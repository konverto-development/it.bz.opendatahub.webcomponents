        ...
        stage('Build & Push') {
            steps {
                sh '''
                    ...
                    docker-compose --no-ansi -f infrastructure/docker/docker-compose.build.yml build --pull --build-arg JENKINS_USER_ID=$(id -u jenkins) JENKINS_GROUP_ID=$(id -g jenkins)
